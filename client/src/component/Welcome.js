        ...
        <div className='flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
            <div className='flex flex-1 justify-start flex-col md:mr-10'>
                ...
                <p className='text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base'>
                    Explore the cryto world. Buy and sell cryptocurrencies easily on Dandelion
                </p>
                <button
                    type='button'
                ...
                <div className='grid sm:grid-cols-3 frid-cols-2 w-full mt-10'>
                    <div className={`rounded-tl-2xl ${commonStyle}`}>
                        Reliability
                    </div>
                    <div className={commonStyle}> Secure</div>
